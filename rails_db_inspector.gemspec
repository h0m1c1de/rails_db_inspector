...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "Mountable Rails engine for SQL query monitoring, N+1 detection, EXPLAIN analysis, and schema visualization."
  spec.description = "Rails DB Inspector is a mountable Rails engine that captures SQL queries in real time, detects N+1 query patterns, runs EXPLAIN/EXPLAIN ANALYZE plans, and visualizes your database schema — all from a built-in dashboard. Supports PostgreSQL and MySQL."
  spec.license     = "MIT"
